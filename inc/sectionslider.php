      ...
      ?>
        ...
        ?>
          ...
          if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
           echo "<a href=$book[Book] class='btn'>Get Book</a>";
           echo "<button class='btn cart' data-id='$book[BookID]' data-price='$book[Price]'>Add to WishList</button>";
          }else{
             if (str_contains($uri,'index')){
           echo "<a href='public/login.php' class='btn'>Get Book</a>"; 
           echo "<button class='btn ' onclick=location.href='public/login.php'>Add to WishList</button>";
             }else{
           echo "<a href='../public/login.php' class='btn'>Get Book</a>" ;
           echo "<button class='btn ' onclick=location.href='../public/login.php'>Add to WishList</button>";
             }
